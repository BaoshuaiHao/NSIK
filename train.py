...
def main(params):
    ...
    train = SubgraphDataset(params.db_path, 'train_pos', 'train_neg', params.file_paths,
                            ...
                            use_global_emb=not params.disable_global_emb,
                            use_node_roles=not params.disable_node_roles)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--disable_attn', action='store_true',
                        help='Disable relation-aware attention/gating in RGCN layers')
    parser.add_argument('--disable_global_emb', action='store_true',
                        help='Disable loading global_emb.npy as node features')
    parser.add_argument('--disable_node_roles', action='store_true',
                        help='Disable loading node_role_ids.npy into subgraphs')

    params = parser.parse_args()
    if params.disable_attn:
        params.has_attn = False
